...
class ReservationSectionDesktop extends StatelessWidget {
  const ReservationSectionDesktop({Key? key}) : super(key: key);
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Secure Your Table at (Your Restaurant Name) and Indulge in a Culinary Journey Through the Mediterranean. Our Reservations are Available Online or by Phone.",
                  style: TextStyle(
                      fontFamily: GoogleFonts.inter().fontFamily,
                      fontSize: 16,
                ...
                decoration: InputDecoration(
                  border: const OutlineInputBorder(
                    borderSide: BorderSide(
                        color: Color.fromRGBO(144, 163, 177, 1), width: 1.0),
                  ),
                  labelText: "Name",
