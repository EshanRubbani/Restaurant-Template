  ...
  void _scrollRight() {
    ...
    return Container(
      ...
      child: Stack(
        children: [
          // Positioned.fill(
          //   child: Image.asset("assets/pngs/background4.png",fit: BoxFit.cover,)),
          Container(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final testimonials = [
                              ...
                              },
                              {
                                ...
                                "description":
                                    "I've been searching for a good Mediterranean restaurant in Toledo, and this has exceeded my expectations.",
                                "name": "John Doe",
