...
void dispose() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Wrap AppBar and Body with Obx to conditionally show AppBar
      body: Obx(() {
        // Show loading screen if data is not yet loaded
                        ...
                        child: DefaultTextStyle(
                          ...
                          child: AnimatedTextKit(
                            ...
                            animatedTexts: [
                              ...
                              TypewriterAnimatedText('Your Restaurant Name'),
                            ],
                            onTap: () {
                              print("Tap Event");
                            },
        ...
        // Once data is loaded, show the content along with the AppBar
        return Scaffold(
          appBar: AppBar(
            backgroundColor: Color.fromRGBO(111, 47, 32, 1),
            leading: Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        // Navigation items
                        _buildDrawerItem("HOME", HomepageMobile()),
                        SizedBox(height: 10),
